CREATE TABLE MUser (Id SERIAL NOT NULL, GenreId int4 NOT NULL, CountryId int4 NOT NULL, Username varchar(255) NOT NULL UNIQUE, Password varchar(255) NOT NULL, Email varchar(255) NOT NULL UNIQUE, Name varchar(255) NOT NULL, BirthDate date NOT NULL, Gender char(1), MovieCount int4 NOT NULL, HoursCount int4 NOT NULL, Avatar varchar(255), JoinDate date NOT NULL, Token varchar(255), TokenLimit timestamp, CommentsCount int4 NOT NULL, RatingsCount int4 NOT NULL, FriendsCount int4 NOT NULL, PRIMARY KEY (Id));
