CREATE TABLE MUser (Id SERIAL NOT NULL, CountryId int4 NOT NULL, Username varchar(255), Password varchar(255), Email varchar(255), Name varchar(255), BirthDate date, Gender bool NOT NULL, MovieCount int4 NOT NULL, HoursCount int4 NOT NULL, Avatar varchar(255), JoinDate date, PRIMARY KEY (Id));
CREATE TABLE Movie (Id SERIAL NOT NULL, Name varchar(255), Poster varchar(255), Backdrop varchar(255), Plot varchar(255), Imdb varchar(255), Release date, Runtime int4 NOT NULL, RatingSum int4 NOT NULL, RatingCount int4 NOT NULL, PRIMARY KEY (Id));
CREATE TABLE Genre (Id SERIAL NOT NULL, Name varchar(255), PRIMARY KEY (Id));
CREATE TABLE Company (Id SERIAL NOT NULL, CountryId int4 NOT NULL, Homepage varchar(255), Name varchar(255), Image varchar(255), Headquarters varchar(255), PRIMARY KEY (Id));
CREATE TABLE Country (Id SERIAL NOT NULL, Name varchar(255), AlphaCode varchar(255), Image varchar(255), PRIMARY KEY (Id));
CREATE TABLE MUserMovie (Id SERIAL NOT NULL, Status bool NOT NULL, Rating int4 NOT NULL, Favourite bool NOT NULL, DateWatched date, DateFavourite date, Visible bool NOT NULL, MovieId int4 NOT NULL, MUserId int4 NOT NULL, PRIMARY KEY (Id));
CREATE TABLE Member (Id SERIAL NOT NULL, Name varchar(255), Image varchar(255), BirthDate date, Gender bool NOT NULL, Imdb varchar(255), Biography varchar(255), BirthPlace varchar(255), PRIMARY KEY (Id));
...
ALTER TABLE MUserMovie ADD CONSTRAINT MUserMovie FOREIGN KEY (MovieId) REFERENCES Movie (Id);
ALTER TABLE MUserMovie ADD CONSTRAINT MUserMovie2 FOREIGN KEY (MUserId) REFERENCES MUser (Id);
...
ALTER TABLE MUser_Friendship ADD CONSTRAINT friends FOREIGN KEY (MUserId) REFERENCES MUser (Id);
ALTER TABLE MUser_Friendship ADD CONSTRAINT friends2 FOREIGN KEY (FriendshipId) REFERENCES Friendship (Id);
