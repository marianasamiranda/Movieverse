...
public class Member {
	...
	public void removeMovie(Movie aMovie) {
		MovieMember[] lMovieMembers = movieMembers.toArray();
	...
	public final MovieMemberSetCollection movieMembers = new MovieMemberSetCollection(this, _ormAdapter, ORMConstants.KEY_MEMBER_MOVIEMEMBERS, ORMConstants.KEY_MOVIEMEMBER_MEMBER, ORMConstants.KEY_MUL_ONE_TO_MANY);
