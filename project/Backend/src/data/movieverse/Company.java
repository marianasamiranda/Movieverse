...
public class Company {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_COMPANY_COMPANY_COUNTRY) {
			this.company_country = (data.movieverse.Country) owner;
		}
	}
	...
	private data.movieverse.Country company_country;
	...
	public void setCompany_country(data.movieverse.Country value) {
		this.company_country = value;
	}
	
	public data.movieverse.Country getCompany_country() {
