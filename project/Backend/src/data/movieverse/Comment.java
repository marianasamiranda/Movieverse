...
public class Comment {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_COMMENT_COMMENTER) {
			this.commenter = (MUser) owner;
		}
		
		else if (key == ORMConstants.KEY_COMMENT_MOVIE) {
			this.movie = (Movie) owner;
		}
	}
	 ...
	 */
	public void setORM_Commenter(MUser value) {
		this.commenter = value;
	}
	
	private MUser getORM_Commenter() {
		return commenter;
	}
	...
	public final MUserSetCollection upvoter = new MUserSetCollection(this, _ormAdapter, ORMConstants.KEY_COMMENT_UPVOTER, ORMConstants.KEY_MUL_MANY_TO_MANY);
	 ...
	 * This method is for internal use only.
	 */
	public void setORM_Movie(Movie value) {
		this.movie = value;
	}
	
	private Movie getORM_Movie() {
		return movie;
	}
