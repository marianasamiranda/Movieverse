...
public class MovieMemberDAO {
	...
	public static MovieMember loadMovieMemberByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (MovieMember) session.load(data.movieverse.MovieMember.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MovieMember getMovieMemberByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (MovieMember) session.get(data.movieverse.MovieMember.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MovieMember loadMovieMemberByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MovieMember) session.load(data.movieverse.MovieMember.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MovieMember getMovieMemberByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MovieMember) session.get(data.movieverse.MovieMember.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryMovieMember(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From data.movieverse.MovieMember as MovieMember");
		if (condition != null)
	...
	public static MovieMember createMovieMember() {
		return new data.movieverse.MovieMember();
	}
	
	public static boolean save(data.movieverse.MovieMember movieMember) throws PersistentException {
		try {
	...
	public static boolean delete(data.movieverse.MovieMember movieMember) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(data.movieverse.MovieMember movieMember)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(data.movieverse.MovieMember movieMember, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (movieMember.getMember() != null) {
				movieMember.getMember().movieMembers.remove(movieMember);
			}
	...
	public static boolean refresh(data.movieverse.MovieMember movieMember) throws PersistentException {
		try {
	...
	public static boolean evict(data.movieverse.MovieMember movieMember) throws PersistentException {
		try {
