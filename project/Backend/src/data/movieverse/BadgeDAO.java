...
public class BadgeDAO {
	...
	public static Badge loadBadgeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Badge) session.load(Badge.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Badge getBadgeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Badge) session.get(Badge.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Badge loadBadgeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Badge) session.load(Badge.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Badge getBadgeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Badge) session.get(Badge.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryBadge(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Badge as Badge");
		if (condition != null)
	...
	public static boolean save(Badge badge) throws PersistentException {
		try {
	...
	public static boolean delete(Badge badge) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(Badge badge)throws PersistentException {
		try {
			Achievement[] lAchievementss = badge.achievements.toArray();
	...
	public static boolean deleteAndDissociate(Badge badge, org.orm.PersistentSession session)throws PersistentException {
		try {
			Achievement[] lAchievementss = badge.achievements.toArray();
			for(int i = 0; i < lAchievementss.length; i++) {
				lAchievementss[i].setBadge(null);
	...
	public static boolean refresh(Badge badge) throws PersistentException {
		try {
	...
	public static boolean evict(Badge badge) throws PersistentException {
		try {
