...
public class Genre {
	...
	public final data.movieverse.MovieSetCollection movies = new data.movieverse.MovieSetCollection(this, _ormAdapter, ORMConstants.KEY_GENRE_MOVIES, ORMConstants.KEY_MOVIE_GENRES, ORMConstants.KEY_MUL_MANY_TO_MANY);
