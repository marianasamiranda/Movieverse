...
public class AchievementDAO {
	...
	public static Achievement loadAchievementByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Achievement) session.load(data.movieverse.Achievement.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Achievement getAchievementByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Achievement) session.get(data.movieverse.Achievement.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Achievement loadAchievementByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Achievement) session.load(data.movieverse.Achievement.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Achievement getAchievementByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Achievement) session.get(data.movieverse.Achievement.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAchievement(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From data.movieverse.Achievement as Achievement");
		if (condition != null)
	...
	public static Achievement createAchievement() {
		return new data.movieverse.Achievement();
	}
	
	public static boolean save(data.movieverse.Achievement achievement) throws PersistentException {
		try {
	...
	public static boolean delete(data.movieverse.Achievement achievement) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(data.movieverse.Achievement achievement)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(data.movieverse.Achievement achievement, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (achievement.getBadge() != null) {
				achievement.getBadge().achievements.remove(achievement);
			}
	...
	public static boolean refresh(data.movieverse.Achievement achievement) throws PersistentException {
		try {
	...
	public static boolean evict(data.movieverse.Achievement achievement) throws PersistentException {
		try {
