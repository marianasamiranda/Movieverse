...
public class UserMovieCriteria extends AbstractORMCriteria {
	...
	public UserMovieCriteria(Criteria criteria) {
		super(criteria);
	...
	public UserMovieCriteria(PersistentSession session) {
		this(session.createCriteria(UserMovie.class));
	}
	
	public UserMovieCriteria() throws PersistentException {
	...
	public UserMovie uniqueUserMovie() {
		return (UserMovie) super.uniqueResult();
	}
	
	public UserMovie[] listUserMovie() {
