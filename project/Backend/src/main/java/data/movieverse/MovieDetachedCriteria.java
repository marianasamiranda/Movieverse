...
public class MovieDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public MovieDetachedCriteria() {
		...
		relatedMovies = new CollectionExpression("ORM_RelatedMovies", this.getDetachedCriteria());
	...
	public MovieDetachedCriteria createRelatedMoviesCriteria() {
		return new MovieDetachedCriteria(createCriteria("ORM_RelatedMovies"));
	}
