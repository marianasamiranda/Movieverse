...
public class MovieCriteria extends AbstractORMCriteria {
	...
	public final CollectionExpression relatedMovies;
	...
	public MovieCriteria(Criteria criteria) {
		...
		relatedMovies = new CollectionExpression("ORM_RelatedMovies", this);
		media = new CollectionExpression("ORM_Media", this);
	}
	...
	public MovieCriteria createRelatedMoviesCriteria() {
		return new MovieCriteria(createCriteria("ORM_RelatedMovies"));
	}
	
	public MediaCriteria createMediaCriteria() {
		return new MediaCriteria(createCriteria("ORM_Media"));
	}
