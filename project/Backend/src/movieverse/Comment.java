...
public class Comment {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_COMMENT_COMMENTER) {
			this.commenter = (movieverse.MUser) owner;
		}
	...
	private movieverse.MUser commenter;
	...
	public void setCommenter(movieverse.MUser value) {
		if (commenter != null) {
	...
	public movieverse.MUser getCommenter() {
		return commenter;
	}
	 ...
	 */
	public void setORM_Commenter(movieverse.MUser value) {
		this.commenter = value;
	}
	
	private movieverse.MUser getORM_Commenter() {
		return commenter;
	}
	...
	public final movieverse.MUserSetCollection upvoter = new movieverse.MUserSetCollection(this, _ormAdapter, ORMConstants.KEY_COMMENT_UPVOTER, ORMConstants.KEY_MUL_MANY_TO_MANY);
