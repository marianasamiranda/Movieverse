...
public class CompanyDAO {
	...
	public static Company loadCompanyByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Company) session.load(movieverse.Company.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Company getCompanyByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Company) session.get(movieverse.Company.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Company loadCompanyByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Company) session.load(movieverse.Company.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Company getCompanyByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Company) session.get(movieverse.Company.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryCompany(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Company as Company");
		if (condition != null)
	...
	public static Company createCompany() {
		return new movieverse.Company();
	}
	
	public static boolean save(movieverse.Company company) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Company company) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Company company)throws PersistentException {
		try {
			movieverse.Movie[] lMoviess = company.movies.toArray();
	...
	public static boolean deleteAndDissociate(movieverse.Company company, org.orm.PersistentSession session)throws PersistentException {
		try {
			movieverse.Movie[] lMoviess = company.movies.toArray();
			for(int i = 0; i < lMoviess.length; i++) {
				lMoviess[i].companies.remove(company);
	...
	public static boolean refresh(movieverse.Company company) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Company company) throws PersistentException {
		try {
