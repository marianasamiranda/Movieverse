...
public class MemberDAO {
	...
	public static Member loadMemberByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Member) session.load(movieverse.Member.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Member getMemberByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Member) session.get(movieverse.Member.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Member loadMemberByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Member) session.load(movieverse.Member.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Member getMemberByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Member) session.get(movieverse.Member.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryMember(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Member as Member");
		if (condition != null)
	...
	public static Member createMember() {
		return new movieverse.Member();
	}
	
	public static boolean save(movieverse.Member member) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Member member) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Member member)throws PersistentException {
		try {
			movieverse.MovieMember[] lMovieMemberss = member.movieMembers.toArray();
	...
	public static boolean deleteAndDissociate(movieverse.Member member, org.orm.PersistentSession session)throws PersistentException {
		try {
			movieverse.MovieMember[] lMovieMemberss = member.movieMembers.toArray();
			for(int i = 0; i < lMovieMemberss.length; i++) {
				lMovieMemberss[i].setMember(null);
	...
	public static boolean refresh(movieverse.Member member) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Member member) throws PersistentException {
		try {
