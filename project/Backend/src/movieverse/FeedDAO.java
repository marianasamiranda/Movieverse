...
public class FeedDAO {
	...
	public static Feed loadFeedByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Feed) session.load(movieverse.Feed.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Feed getFeedByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Feed) session.get(movieverse.Feed.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Feed loadFeedByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Feed) session.load(movieverse.Feed.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Feed getFeedByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Feed) session.get(movieverse.Feed.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryFeed(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Feed as Feed");
		if (condition != null)
	...
	public static Feed createFeed() {
		return new movieverse.Feed();
	}
	
	public static boolean save(movieverse.Feed feed) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Feed feed) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Feed feed)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Feed feed, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (feed.getUser() != null) {
				feed.getUser().feed.remove(feed);
			}
	...
	public static boolean refresh(movieverse.Feed feed) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Feed feed) throws PersistentException {
		try {
