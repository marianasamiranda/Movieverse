...
public class CountryDAO {
	...
	public static Country loadCountryByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Country) session.load(movieverse.Country.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Country getCountryByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Country) session.get(movieverse.Country.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Country loadCountryByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Country) session.load(movieverse.Country.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Country getCountryByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Country) session.get(movieverse.Country.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryCountry(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Country as Country");
		if (condition != null)
	...
	public static Country createCountry() {
		return new movieverse.Country();
	}
	
	public static boolean save(movieverse.Country country) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Country country) throws PersistentException {
		try {
	...
	public static boolean refresh(movieverse.Country country) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Country country) throws PersistentException {
		try {
