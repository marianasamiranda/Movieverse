...
public class FriendshipDAO {
	...
	public static Friendship loadFriendshipByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Friendship) session.load(movieverse.Friendship.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Friendship getFriendshipByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Friendship) session.get(movieverse.Friendship.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Friendship loadFriendshipByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Friendship) session.load(movieverse.Friendship.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Friendship getFriendshipByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Friendship) session.get(movieverse.Friendship.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryFriendship(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Friendship as Friendship");
		if (condition != null)
	...
	public static Friendship createFriendship() {
		return new movieverse.Friendship();
	}
	
	public static boolean save(movieverse.Friendship friendship) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Friendship friendship) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Friendship friendship)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Friendship friendship, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (friendship.getReceivedMuser() != null) {
				friendship.getReceivedMuser().requestedFriendships.remove(friendship);
			}
	...
	public static boolean refresh(movieverse.Friendship friendship) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Friendship friendship) throws PersistentException {
		try {
