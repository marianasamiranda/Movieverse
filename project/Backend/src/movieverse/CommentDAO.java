...
public class CommentDAO {
	...
	public static Comment loadCommentByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comment) session.load(movieverse.Comment.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comment getCommentByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comment) session.get(movieverse.Comment.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comment loadCommentByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comment) session.load(movieverse.Comment.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comment getCommentByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comment) session.get(movieverse.Comment.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryComment(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Comment as Comment");
		if (condition != null)
	...
	public static Comment createComment() {
		return new movieverse.Comment();
	}
	
	public static boolean save(movieverse.Comment comment) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Comment comment) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Comment comment)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Comment comment, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (comment.getMovie() != null) {
				comment.getMovie().comments.remove(comment);
			}
	...
	public static boolean refresh(movieverse.Comment comment) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Comment comment) throws PersistentException {
		try {
