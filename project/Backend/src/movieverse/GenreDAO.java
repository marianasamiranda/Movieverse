...
public class GenreDAO {
	...
	public static Genre loadGenreByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Genre) session.load(movieverse.Genre.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Genre getGenreByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Genre) session.get(movieverse.Genre.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Genre loadGenreByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Genre) session.load(movieverse.Genre.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Genre getGenreByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Genre) session.get(movieverse.Genre.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryGenre(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Genre as Genre");
		if (condition != null)
	...
	public static Genre createGenre() {
		return new movieverse.Genre();
	}
	
	public static boolean save(movieverse.Genre genre) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Genre genre) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Genre genre)throws PersistentException {
		try {
			movieverse.Movie[] lMoviess = genre.movies.toArray();
	...
	public static boolean deleteAndDissociate(movieverse.Genre genre, org.orm.PersistentSession session)throws PersistentException {
		try {
			movieverse.Movie[] lMoviess = genre.movies.toArray();
			for(int i = 0; i < lMoviess.length; i++) {
				lMoviess[i].genres.remove(genre);
	...
	public static boolean refresh(movieverse.Genre genre) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Genre genre) throws PersistentException {
		try {
