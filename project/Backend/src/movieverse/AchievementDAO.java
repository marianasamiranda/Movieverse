...
public class AchievementDAO {
	...
	public static Achievement loadAchievementByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Achievement) session.load(movieverse.Achievement.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Achievement getAchievementByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Achievement) session.get(movieverse.Achievement.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Achievement loadAchievementByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Achievement) session.load(movieverse.Achievement.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Achievement getAchievementByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Achievement) session.get(movieverse.Achievement.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAchievement(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Achievement as Achievement");
		if (condition != null)
	...
	public static Achievement createAchievement() {
		return new movieverse.Achievement();
	}
	
	public static boolean save(movieverse.Achievement achievement) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Achievement achievement) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Achievement achievement)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Achievement achievement, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (achievement.getBadge() != null) {
				achievement.getBadge().achievements.remove(achievement);
			}
	...
	public static boolean refresh(movieverse.Achievement achievement) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Achievement achievement) throws PersistentException {
		try {
