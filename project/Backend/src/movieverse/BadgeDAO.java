...
public class BadgeDAO {
	...
	public static Badge loadBadgeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Badge) session.load(movieverse.Badge.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Badge getBadgeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Badge) session.get(movieverse.Badge.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Badge loadBadgeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Badge) session.load(movieverse.Badge.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Badge getBadgeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Badge) session.get(movieverse.Badge.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryBadge(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From movieverse.Badge as Badge");
		if (condition != null)
	...
	public static Badge createBadge() {
		return new movieverse.Badge();
	}
	
	public static boolean save(movieverse.Badge badge) throws PersistentException {
		try {
	...
	public static boolean delete(movieverse.Badge badge) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(movieverse.Badge badge)throws PersistentException {
		try {
			movieverse.Achievement[] lAchievementss = badge.achievements.toArray();
	...
	public static boolean deleteAndDissociate(movieverse.Badge badge, org.orm.PersistentSession session)throws PersistentException {
		try {
			movieverse.Achievement[] lAchievementss = badge.achievements.toArray();
			for(int i = 0; i < lAchievementss.length; i++) {
				lAchievementss[i].setBadge(null);
	...
	public static boolean refresh(movieverse.Badge badge) throws PersistentException {
		try {
	...
	public static boolean evict(movieverse.Badge badge) throws PersistentException {
		try {
